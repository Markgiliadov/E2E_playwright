...
export default defineConfig({
  ...
  projects: [
    {
      name: "Chromium",
      use: { ...devices["Desktop Chrome"] }, // Uses desktop Chrome for testing
    },
    {
      name: "Firefox",
      use: { ...devices["Desktop Firefox"] }, // Uses desktop Firefox for testing
    },
    {
      name: "WebKit",
      use: { ...devices["Desktop Safari"] }, // Uses desktop Safari for testing
    },
  ],
});
